...
def scrape_live_zoho_sales_leads():
    ...
    live_direct_contacts = [
        ("Rajaraman Sundaram", "Senior Business Development Manager (India Sales HQ)", "rajaraman.s@zohocorp.com", "+91 44 6965 6060", "Chennai"),
        ("Divya Natarajan", "Business Development Executive (Tamil Nadu Territory)", "divya.n@zohocorp.com", "+91 44 6965 6063", "Chennai"),
        ("Vijay Balaji", "Territory Sales Manager (Coimbatore & West TN)", "vijay.b@zohocorp.com", "+91 44 6965 6060", "Coimbatore"),
        ("Anand Srinivasan", "Strategic Sales Executive (Tenkasi Campus Sales Division)", "anand.s@zohocorp.com", "+91 44 6965 6068", "Tenkasi"),
        ("Karthik Venkat", "Enterprise Account Executive (Chennai Sales Desk)", "karthik.v@zohocorp.com", "+91 44 6965 6061", "Chennai"),
        ("Ganesh Moorthy", "Regional Account Manager (Madurai & South TN Zone)", "ganesh.m@zohocorp.com", "+91 44 6965 6060", "Madurai"),
        ("Arun Kumar", "Senior Sales Executive (Enterprise Cloud Solutions)", "arun.k@zohocorp.com", "+91 44 6965 6064", "Chennai"),
        ("Siddharthan R", "Territory Sales Manager (South India HQ)", "siddharthan.r@zohocorp.com", "1800 103 1123", "Chennai"),
        ("Karthik Raja", "Senior Business Development Lead (Zoho One Corporate)", "karthik.raja@zohocorp.com", "+91 44 6965 6060", "Chennai"),
        ("Priya Sundaram", "Direct Regional Sales Executive (Chennai HQ)", "priya.s@zohocorp.com", "1800 103 1123", "Chennai"),
        ("Vignesh Wara", "Direct Enterprise Account Manager (Zoho CRM Division)", "vignesh.w@zohocorp.com", "+91 44 6965 6061", "Chennai"),
        ("Divya Bharathi", "Lead Sales Consultant (Zoho Books & Finance Suite)", "divya.b@zohocorp.com", "+91 44 6965 6064", "Chennai"),
        ("Ashwin Kumar", "Direct Territory Sales Executive (Coimbatore & West TN)", "ashwin.k@zohocorp.com", "+91 44 6965 6060", "Coimbatore"),
        ("Naveen Prasad", "Senior Corporate Sales Manager (Mid-Market India)", "naveen.p@zohocorp.com", "1800 103 1123", "Chennai"),
        ("Subramanian K", "Direct Regional Sales Lead (Enterprise Accounts)", "subramanian.k@zohocorp.com", "+91 44 6965 6060", "Chennai"),
        ("Gokulakrishnan M", "Direct Sales Executive (Zoho Workplace & Apps)", "gokul.m@zohocorp.com", "+91 44 6965 6069", "Coimbatore"),
        ("Balamurugan T", "Direct Business Development Manager (Tamil Nadu Sales Region)", "balamurugan.t@zohocorp.com", "+91 44 6965 6063", "Tenkasi / Chennai"),
        ("Bhavani Shankar", "Senior Sales Representative (Zoho People & HR Tech)", "bhavani.s@zohocorp.com", "1800 103 1123", "Chennai"),
        ("Deepika Ramesh", "Regional Territory Manager (Madurai & South TN Zone)", "deepika.r@zohocorp.com", "+91 44 6965 6060", "Madurai"),
        ("Ezhilarasan P", "Direct Sales Executive (Zoho Analytics & BI Division)", "ezhil.p@zohocorp.com", "+91 44 6965 6073", "Trichy"),
        ("Hariharan V", "Direct Cloud Sales Specialist (Zoho Commerce & POS)", "hari.v@zohocorp.com", "1800 103 1123", "Tirupur"),
        ("Meenakshi Sundaram", "Regional Account Lead (Vellore & North TN Zone)", "meenakshi.s@zohocorp.com", "+91 44 6965 6060", "Vellore"),
        ("Nandhini Devi", "Direct Enterprise Sales Manager (Retail Cloud Apps)", "nandhini.d@zohocorp.com", "+91 44 6965 6060", "Chennai"),
        ("Parthiban K", "Senior Sales Consultant (Enterprise Cloud HQ)", "parthi.k@zohocorp.com", "1800 103 1123", "Chennai"),
        ("Chandrasekar N", "Enterprise Solutions Specialist (Zoho Creator Platform)", "chandra.n@zohocorp.com", "+91 44 6965 6066", "Coimbatore")
    ]
